...
```
wget https://github.com/garybowers/shifter/releases/download/v0.7/shifter-linux-amd64
...
```
INPUT_LOCATION=INPUT_LOCATION=ocp-manifests/namespaces/$NAMESPACE
ls $INPUT_LOCATION
```
...
**NOTE** It may take a few minutes for the External_IP to be assigned.
