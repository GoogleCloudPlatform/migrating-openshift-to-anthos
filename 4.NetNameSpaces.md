...
Retrieve the list of NetNamespaces for the openshift projects of interest. These will be saved into `projectconfigs/net-namespaces` folder for future reference.
